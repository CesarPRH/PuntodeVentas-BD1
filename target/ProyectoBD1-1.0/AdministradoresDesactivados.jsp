<%-- 
    Document   : AdministradoresDesactivados
    Created on : 1/11/2023, 17:28:40
    Author     : Cesar S
--%>
...
<html>
    ...
    //c.rs.next();
    int num = c.contarFilasDesactivados("Administradores");
    c.MostrarAdministradoresInactivos();
        %>
    <head>
       <meta charset="UTF-8">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue recuperado con éxito.', 'success').then(() => {
                   SetSession('RecuperarAdministrador',id);
                });
					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							<div class="full-width panel-tittle bg-success text-center tittles">
								Lista de Administradores desactivados
							</div>
							<div class="full-width panel-content">
									...
									<div class="mdl-list__item mdl-list__item--two-line">
										...
										<span class="mdl-list__item-primary-content">
                                                                                    <span>No existe administradores desactivados.</span>
									</div>
                                                            ...
                                                            <span class="mdl-typography--text-center">Existen <%=num  %> administradores(s) desactivados.</span>
									...
									<div class="mdl-list__item mdl-list__item--two-line Lista">
										...
										<span class="mdl-list__item-primary-content">
											<i class="zmdi zmdi-account mdl-list__item-avatar"></i>
                                                                                        <span><%=c.rs.getString("nombre_empleado")%> <%=c.rs.getString("apellido")  %> | Usuario: <%=c.rs.getString("usuario") %></span>

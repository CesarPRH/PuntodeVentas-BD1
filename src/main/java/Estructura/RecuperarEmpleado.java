    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                c.RecuperarEmpleado(i_id);
                c.RecuperarUsuario(i_idUsuario);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RecuperarEmpleado</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RecuperarEmpleado at " + request.getContextPath() + s_id + i_idUsuario + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }

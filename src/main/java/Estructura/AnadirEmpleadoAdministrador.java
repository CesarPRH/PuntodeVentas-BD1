 ...
 * @author Cesar S
 */
public class AnadirEmpleadoAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String redirected = "Administrador";
            ...
            out.println("<html> <body>");
               ...
               out.println("<p>" + s_nombre+" "+s_apellido+" "+s_dpi+" "+s_telefono+" "+s_direccion+" " + "</p>");
            out.println("<p>" + s_puesto+" "+s_fechaContratacion+" "+s_usuario+" "+s_contraseña+" "+ "</p>");

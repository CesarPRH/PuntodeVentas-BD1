 ...
 * @author Cesar S
 */
public class ActualizarEmpleadoAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                while(c.rs.next()){
             i_idAdmin = c.rs.getInt("id_administradores");}
                System.out.println("Se consiguio un id de admin:"+s_id);
                System.out.println("Id del admin: "+i_idAdmin);
            ...
            if(s_id!=null && s_nombre!= null && s_apellido!=null && s_dpi != null && s_telefono != null &&
                    ...
                    s_contraseña!= null &&  i_idAdmin != null){
            ...
            try{
                ...
                try{
                    ...
                    c.ActualizarAdmin(i_idAdmin, i_id, s_usuario, s_contraseña);

<%-- 
    Document   : ProductosDesactivados
    Created on : 31/10/2023, 21:49:19
    Author     : Cesar S
--%>
...
<html>
    ...
    //c.rs.next();
    int num = c.contarFilasDesactivados("productos");
    c.mostrarProductosInactivos();
        %>
    <head>
       <meta charset="UTF-8">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue recuperado con éxito.', 'success').then(() => {
                   SetSession('RecuperarProductos',id);
                });
							...
							<div class="full-width panel-content">
									...
									<div class="mdl-list__item mdl-list__item--two-line">
										...
										<span class="mdl-list__item-primary-content">
                                                                                    <span>No existe productos desactivados.</span>
									</div>
                                                            ...
                                                            <span class="mdl-typography--text-center">Existen <%=num  %> producto(s) desactivados.</span>
								...
								<div class="mdl-list listFiltro">
									<div class="mdl-list__item mdl-list__item--two-line Lista">
										...
										<span class="mdl-list__item-primary-content">
											...
											<span><%=c.rs.getString("producto")%></span>
                                                                                        <span class="mdl-list__item-sub-title">ID:<%=c.rs.getInt("id_productos")  %> || Precio:<%=c.rs.getFloat("precio") %></span>
										</span>
                                                                                        <a class="mdl-list__item-secondary-action"  onclick="verificar(this)" data-id="<%=c.rs.getInt("id_productos")%>" style="color:black"><i class="zmdi zmdi-archive"></i></a>
									</div>

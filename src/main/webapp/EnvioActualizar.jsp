<%-- 
    Document   : EnvioActualizar
    Created on : 1/11/2023, 21:52:01
    Author     : Cesar S
--%>
...
<html lang="es">
    <%
        ...
        c.ConseguirInfoMetodosEnvio(id);
        c.rs.next();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue añadido con éxito.', 'success').then(() => {
                  document.form.action = 'ActualizarMetodoEnvio';
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue actualizado con éxito.', 'success').then(() => {
                    document.form.action = 'EliminarMetodoEnvio';
                    document.form.submit();
                });
            } else if (result.isDismissed) {
                Swal.fire('Cancelado.', 'Cancelaste la transacción :(', 'error').then(() => {
                                ...
                                <div class="full-width panel-content">
									...
									<h5 class="text-condensedLight">Data payment</h5>
                                                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                            <input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NamePayment" name="txt_id" value="<%=c.rs.getInt("id_metodos_envio") %>" readonly>
										<label class="mdl-textfield__label" for="NamePayment">Id (No podrás modificar esto)</label>
										<span class="mdl-textfield__error">Id Inválido</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                            <input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NamePayment" name="txt_nombre" value="<%=c.rs.getString("nombre")  %>">
										<label class="mdl-textfield__label" for="NamePayment">Name</label>
										<span class="mdl-textfield__error">Invalid name</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                            <input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="descriptionPayment"name="txt_descripcion" value="<%=c.rs.getString("descripcion")  %>">
										...
										<span class="mdl-textfield__error">Invalid description</span>
                                                                        ...
                                                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                            <input class="mdl-textfield__input" type="text" pattern="-?[0-9.]*(\.[0-9]+)?" id="CostoProducto" name="txt_costo" value="<%=c.rs.getFloat("costo")  %>">
									...
									<p class="text-center">
                                                        ...
                                                        <div class="mdl-tooltip" for="btn-addCategory">Actualizar Metodo de Envio</div>
                                                        <div class="mdl-tooltip" for="btn-deleteCategoria">Desactivar Metodo de Envio</div>

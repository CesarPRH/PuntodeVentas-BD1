<%-- 
    Document   : MetodoEnvioDesactivado
    Created on : 1/11/2023, 22:26:32
    Author     : Cesar S
--%>
...
<html>
    ...
    //c.rs.next();
    int num = c.contarFilasDesactivados("metodos_envio");
    c.ConseguirMetodosEnvioInactivos();
        %>
    <head>
       <meta charset="UTF-8">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue recuperado con éxito.', 'success').then(() => {
                   SetSession('RecuperarMetodoEnvio',id);
                });
					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							<div class="full-width panel-tittle bg-success text-center tittles">
								Lista de metodos de envío desactivados
							</div>
							<div class="full-width panel-content">
									...
									<div class="mdl-list__item mdl-list__item--two-line">
										...
										<span class="mdl-list__item-primary-content">
                                                                                    <span>No existe métodos de envío desactivadas.</span>
									</div>
                                                            ...
                                                            <span class="mdl-typography--text-center">Existen <%=num  %> metodo(s) de envío desactivados.</span>
									...
									<div class="mdl-list__item mdl-list__item--two-line Lista">
										...
										<span class="mdl-list__item-primary-content">
											...
											<span><%=c.rs.getString("nombre")%></span>
                                                                                        <span class="mdl-list__item-sub-title">ID:<%=c.rs.getInt("id_metodos_envio")  %> || Precio:<%=c.rs.getFloat("costo") %></span>
										</span>
                                                                                        <a class="mdl-list__item-secondary-action"  onclick="verificar(this)" data-id="<%=c.rs.getInt("id_metodos_envio")%>" style="color:black"><i class="zmdi zmdi-archive"></i></a>
									</div>

        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue añadido con éxito.', 'success').then(() => {
                  document.form.action = 'ActualizarEmpleadoAdministrador';
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire('¡Perfecto!', 'El cliente fue actualizado con éxito.', 'success').then(() => {
                    document.form.action = 'DesactivarEmpleadoAdministrador';
                    document.form.submit();
                });
            } else if (result.isDismissed) {
                Swal.fire('Cancelado.', 'Cancelaste la transacción :(', 'error').then(() => {
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												...
												<span class="mdl-textfield__error">Nombre de Usuario Inválido</span>
                                                                                        ...
                                                                                        <!-- Contraseña -->
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                                            <input class="mdl-textfield__input" type="password" id="ContrasenaAdmin" name="txt_contraseña" value="<%=c.rsAux.getString("contrasena")%>">
